...
import { TrendingUp, Receipt, Users, Package, PlusCircle } from 'lucide-react';
...
const config: Record<LedgerEntryType, { labelKey: string; className: string; Icon: React.ElementType }> = {
    ...
    fund:               { labelKey: 'accounting.fund',             className: 'bg-purple-100 text-purple-700 border-purple-200',    Icon: PlusCircle },
};
